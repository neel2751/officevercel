...
// leave/@admin/page.jsx
import React from "react";
import { ChartPie, ClipboardCheck } from "lucide-react";
import Overview from "../components/overview/overview";
import SiteNavBar from "./[slug]/leaveNavbar";

const AdminPage = async ({ params }) => {
  const slug = (await params).slug;
  const adminMenu = [
    { name: "Overview", icon: <ChartPie />, link: "overview" },
    { name: "Checklist", icon: <ClipboardCheck />, link: "checklist" },
  ];
